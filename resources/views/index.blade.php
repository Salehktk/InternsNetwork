...
<div class="content-wrapper">
    ...
    <div id="emailInput" style="display: none;">
        ...
        <input type="text" id="userEmails" name="userEmails" placeholder="Enter email(s) here testing@gmail.com,testing2@gmail.com" >
    </div>
@endif --}}
            ...
            <select id="client" class="js-example-tags" name="client"  multiple="multiple" required>
                ...
                <input type="text" id="deadline" name="deadline" placeholder="Select a date" class="form-control" required>
